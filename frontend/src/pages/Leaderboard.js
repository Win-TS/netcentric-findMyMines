...
export const Leaderboard = () => {
  ...
  return (
    ...
    <Link to="/">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 20 20"><path fill="#f24e1e" d="M2.93 17.07A10 10 0 1 1 17.07 2.93A10 10 0 0 1 2.93 17.07zM11.4 10l2.83-2.83l-1.41-1.41L10 8.59L7.17 5.76L5.76 7.17L8.59 10l-2.83 2.83l1.41 1.41L10 11.41l2.83 2.83l1.41-1.41L11.41 10z"/></svg>
        </button>
      </Link>  
      <div className="back">
        <div className="front">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 grid">
                  {leaderboards.map((player, index) => (
                    ...
                    >
                      ...
                      <div className ="star"><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 512 512"><g transform="rotate(180 256 256)"><path fill="#ff6d60" d="M394 480a16 16 0 0 1-9.39-3L256 383.76L127.39 477a16 16 0 0 1-24.55-18.08L153 310.35L23 221.2a16 16 0 0 1 9-29.2h160.38l48.4-148.95a16 16 0 0 1 30.44 0l48.4 149H480a16 16 0 0 1 9.05 29.2L359 310.35l50.13 148.53A16 16 0 0 1 394 480Z"/></g></svg></div> )}
